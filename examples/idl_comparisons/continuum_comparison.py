...
ion_kwargs = {'abundance': idl_result_freefree['abundance'], 'ionization_filename': idl_result_freefree['ionization_fraction']}
...
ion_kwargs = {'abundance': idl_result_freebound['abundance'], 'ionization_filename': idl_result_freebound['ionization_fraction']}
...
ion_kwargs = {'abundance': idl_result_twophoton['abundance'], 'ionization_filename': idl_result_twophoton['ionization_fraction']}
