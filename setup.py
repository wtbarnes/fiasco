...
PACKAGENAME = metadata.get('package_name', 'fiasco')
DESCRIPTION = metadata.get('description', 'fiasco')
AUTHOR = metadata.get('author', 'Will Barnes')
AUTHOR_EMAIL = metadata.get('author_email', '')
LICENSE = metadata.get('license', 'unknown')
URL = metadata.get('url', 'https://github.com/wtbarnes/fiasco')
